...
mod CLVault {
    ...
    use strategies::utils::constants::Constants::{DECIMALS};
    ...
    impl CLVaultImpl of ICLVault<ContractState> {
        ...
        fn position_rebalance(ref self: ContractState, new_bounds: Bounds) {
            ...
            let primary_balanee = IERC20Dispatcher { contract_address: constants::ETH()}.balance_of(get_caller_address());
            let secondary_balanee = IERC20Dispatcher { contract_address: constants::wstETH()}.balance_of(get_caller_address());
